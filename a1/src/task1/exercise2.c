...
int futhark_entry_process_idx(struct futhark_context *ctx, int64_t *out0,
                              int64_t *out1, const struct futhark_i64_1d *in0,
                              const struct futhark_i64_1d *in1);
...
static void futrts_cli_entry_process_idx(struct futhark_context *ctx)
{
    ...
    struct futhark_i64_1d *read_value_4364;
    int64_t read_shape_4365[1];
    int64_t *read_arr_4366 = NULL;
    
    errno = 0;
    if (read_array(&i64_info, (void **) &read_arr_4366, read_shape_4365, 1) !=
        0)
        futhark_panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 0,
                      "[]", i64_info.type_name, strerror(errno));
    
    struct futhark_i64_1d *read_value_4367;
    int64_t read_shape_4368[1];
    int64_t *read_arr_4369 = NULL;
    
    errno = 0;
    if (read_array(&i64_info, (void **) &read_arr_4369, read_shape_4368, 1) !=
        0)
        futhark_panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 1,
                      "[]", i64_info.type_name, strerror(errno));
    if (end_of_input() != 0)
    ...
    if (perform_warmup) {
        ...
        assert((read_value_4364 = futhark_new_i64_1d(ctx, read_arr_4366,
                                                     read_shape_4365[0])) != 0);
        assert((read_value_4367 = futhark_new_i64_1d(ctx, read_arr_4369,
                                                     read_shape_4368[0])) != 0);
        ...
        r = futhark_entry_process_idx(ctx, &result_4370, &result_4371,
                                      read_value_4364, read_value_4367);
        if (r != 0)
            futhark_panic(1, "%s", futhark_context_get_error(ctx));
        if (futhark_context_sync(ctx) != 0)
            futhark_panic(1, "%s", futhark_context_get_error(ctx));
        ...
        assert(futhark_free_i64_1d(ctx, read_value_4364) == 0);
        assert(futhark_free_i64_1d(ctx, read_value_4367) == 0);
        ;
        ;
    }
    time_runs = 1;
    ...
    write_scalar(stdout, binary_output, &i64_info, &result_4370);
    printf("\n");
    write_scalar(stdout, binary_output, &i64_info, &result_4371);
    printf("\n");
    ;
    ;
}
...
int main(int argc, char **argv)
{
    ...
    struct entry_point_entry entry_points[] = {{.name ="process_idx", .fun =
                                                futrts_cli_entry_process_idx}};
...
static int futrts_process_idx(struct futhark_context *ctx,
                              int64_t *out_scalar_out_4362,
                              int64_t *out_scalar_out_4363,
                              struct memblock signal1_mem_4356,
                              struct memblock signal2_mem_4357, int64_t n_4323,
                              int64_t n_4324);
                              ...
                              int64_t n_4324)
{
    ...
    int err = 0;
    int64_t scalar_out_4358;
    int64_t scalar_out_4359;
    bool dim_match_4327 = n_4323 == n_4324;
    bool empty_or_match_cert_4328;
    
    if (!dim_match_4327) {
        ctx->error = msgprintf("Error: %s\n\nBacktrace:\n%s",
                               "function arguments of wrong shape",
                               "-> #0  exercise2.fut:14:1-21:69\n");
        return 1;
    }
    ...
    redout_4351 = -1;
    redout_4352 = -1;
    for (int64_t i_4353 = 0; i_4353 < n_4323; i_4353++) {
        int64_t x_4346 = ((int64_t *) signal1_mem_4356.mem)[i_4353];
        int64_t x_4347 = ((int64_t *) signal2_mem_4357.mem)[i_4353];
        int64_t res_4349 = sub64(x_4346, x_4347);
        int64_t res_4350 = abs(res_4349);
        bool cond_4337 = slt64(res_4350, redout_4352);
        int64_t res_4338;
        int64_t res_4339;
        
        if (cond_4337) {
            res_4338 = redout_4351;
            res_4339 = redout_4352;
        } else {
            bool cond_4340 = slt64(redout_4352, res_4350);
            int64_t res_4341;
            int64_t res_4342;
            ...
            if (cond_4340) {
                ...
                bool cond_4343 = slt64(redout_4351, i_4353);
                int64_t res_4344;
                
                if (cond_4343) {
                    res_4344 = i_4353;
                } else {
                    res_4344 = redout_4351;
                }
        ...
        int64_t redout_tmp_4360 = res_4338;
        int64_t redout_tmp_4361 = res_4339;
        
        redout_4351 = redout_tmp_4360;
        redout_4352 = redout_tmp_4361;
    }
    res_4331 = redout_4351;
    res_4332 = redout_4352;
    scalar_out_4358 = res_4331;
    scalar_out_4359 = res_4332;
    *out_scalar_out_4362 = scalar_out_4358;
    *out_scalar_out_4363 = scalar_out_4359;
                              ...
                              const struct futhark_i64_1d *in1)
{
    ...
    signal1_mem_4356.references = NULL;
    
    struct memblock signal2_mem_4357;
    
    signal2_mem_4357.references = NULL;
    ...
    lock_lock(&ctx->lock);
    signal1_mem_4356 = in0->mem;
    n_4323 = in0->shape[0];
    signal2_mem_4357 = in1->mem;
    n_4324 = in1->shape[0];
    
    int ret = futrts_process_idx(ctx, &scalar_out_4358, &scalar_out_4359,
                                 signal1_mem_4356, signal2_mem_4357, n_4323,
                                 n_4324);
    
    if (ret == 0) {
        *out0 = scalar_out_4358;
        *out1 = scalar_out_4359;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
